...
import Barchart from '/src/components/other/TGF-TimeDistribution.astro'
import Linechart from '/src/components/other/TGF-Attendance.astro'
import Linechart2 from '/src/components/other/TGF-FinishingTimes.astro'
import Doughnutchart from '/src/components/other/TGF-Generations.astro'
