...
socialImage: '../images/post-images/social/spraycans_social.jpg'
postImages:
  - '../images/post-images/spraycans.jpg'
---

import { getImage, GatsbyImage } from 'gatsby-plugin-image'

<div className="is-gi-medium">
  <GatsbyImage
    alt="lots of colourful spray cans"
    title="all the colours of fresh paint"
    image={getImage(props.frontmatter.postImages[0])}
    className="ml-4 is-pulled-right"
  />
</div>
