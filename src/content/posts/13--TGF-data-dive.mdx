...
slug: TGF-data-dive
pubDate: 2022-03-19
description: 'Analyzing data from The Great Field parkrun, uncovering trends and insights from the first 20 events.'
postImage:
...
import Barchart from '/src/components/for_posts/TGF-TimeDistribution.astro'
import Linechart from '/src/components/for_posts/TGF-Attendance.astro'
import Linechart2 from '/src/components/for_posts/TGF-FinishingTimes.astro'
import Doughnutchart from '/src/components/for_posts/TGF-Generations.astro'
...
<Linechart chartClass="chartFull"/>
...
<Linechart2 chartClass="chartFull" /> 
