...
I'm defintely going to continue to try and get some meaningful data around our voluteers. Volunteering is such an important part of the event for me both me as an inidividual but it's also imperative for the success and sustainability of our event . I feel it's important we understand more about how our volunteers add value and if there are any patterns we can learn from. Much of this we already do through other methods (like talking to each other) but I'd still like to play around with the data.

I'm also keen experiment looking at event data from event elsewhere - both in terms of understanding how successful events grow over time but also just in terms of similarities and differences. Maybe I could start looking for our parkrun event twin?!!
