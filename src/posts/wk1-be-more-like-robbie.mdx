...
postImages:
  - '../images/post-images/cute-dog.jpg'
---

<img
  src="../images/post-images/kermit.gif"
  className="medium-post-image mb-3 ml-3 is-pulled-right rounded-corners"
  title="kermit types fast"
/>
...
<img
  src="../images/post-images/data.gif"
  className="small-post-image mb-3 ml-3 is-pulled-right rounded corners"
  title="multi-tasking"
/>
