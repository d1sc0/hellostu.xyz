...
postImage:
  src: '../post_images/tgf_busesRIGHT.jpg'
...
import Barchart from '/src/components/react/charts/barchart.jsx'
import Linechart from '/src/components/react/charts/linechart.jsx'
import Doughnutchart from '/src/components/react/charts/doughnutchart.jsx'
...
<Linechart data="attendance" chartClass="chartFull" client:visible/>
...
<Doughnutchart chartClass="imageRight" client:visible />
...
<Linechart data="fasttimes" chartClass="chartFull" client:visible /> 
...
<Barchart chartClass="imageRight" client:visible/>
